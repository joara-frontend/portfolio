...
function MetaRowSkeleton() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "11px" }}>
      {/* 라벨 chip */}
      <Skeleton style={{ width: "68px", height: "32px", borderRadius: "9px", flexShrink: 0 }} />
      {/* 값 텍스트 */}
...
export function ProjectMetaSkeleton() {
  return (
    <div style={{ marginTop: "34px" }}>
      {/* h1 제목 */}
      <Skeleton style={{ width: "55%", height: "42px", marginBottom: "24px", borderRadius: "12px" }} />
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "9px", marginBottom: "24px" }}>
        {[72, 60, 88, 64].map((w, i) => (
          <Skeleton key={i} style={{ width: `${w}px`, height: "38px", borderRadius: "12px" }} />
        ))}
      </div>

      {/* 링크 chip 2개 */}
      <div style={{ display: "flex", gap: "10px" }}>
        <Skeleton style={{ width: "110px", height: "38px", borderRadius: "12px" }} />
        <Skeleton style={{ width: "90px", height: "38px", borderRadius: "12px" }} />
      </div>
    </div>
  );
}
